		...
		Date currentDate = new Date();
		 ...
		 try {
			 ...
			 while(true) {
				 ...
				 String displayDate = driver.findElement(By.xpath("//div[@class='cMjqn j']/div[1]/div[1]/div")).getText();
				// String displayDate2 = driver.findElement(By.xpath("//*[@id=\"CategoryDetail\"]//table/tbody[2]/tr[1]//tr[1]/th[2]")).getText();
				 ...
				 if(expMonthYear.equals(displayDate)) {
					 ...
					 driver.findElement(By.xpath("//div[@class='cMjqn j']/div[1]//div[@class='clVco']/div[text()='"+dayInt+"']")).click();
					 break;
				 }
					 ...
					 driver.findElement(By.xpath("//div[@class='dhJeW _Q z f k w']/div[2]")).click();
				 }
				 else if(dateTypeOfdateOfJouney.compareTo(currentDate)<0) {
					 driver.findElement(By.xpath("//div[@class='dhJeW _Q z f k w']/div[1]")).click();
				 }
